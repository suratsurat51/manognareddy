...
<meta name="description"
	content="Exclusive collection of cute and mind-blowing newBorn photographs taken by Manogna Reddy Experience the best photoshoot of your newBorn with Manogna Reddy. NewBorn photographer, Hyderabad." />
<title>NewBorn | toddler | babies | baby Photography by Manogna Reddy, Hyderabad</title>
<meta charset="UTF-8">
...
<body>
			...
			<nav class="navbar navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
						...
						<li class="nav-item"><a class="nav-link link text-blue display-4" id="newBornMenu" href="newBorn"> &nbsp;New-born</a></li>
	...
	<section class="carousel slide cid-qtvcqPaJB9" data-interval="false" id="slider2-14" data-rv-view="2268">
		<div class="container content-slider" id="desktopView">
					...
					<div class="mbr-slider slide carousel" data-pause="true" data-keyboard="false" data-ride="false" data-interval="false">
						<div class="container">
							...
							<div class="carousel-inner" role="listbox">
								<%-- 						 --%>
								<c:forEach var="i" begin="0" end="${maxTagCount-1}">
									<div class="carousel-item slider-fullscreen-image <c:if test="${i == 0}"> active</c:if>" id="sd1" data-bg-video-slide="false"
										style="background-image: url(photos/newBorn/max/<c:out value='${imagesArr[i]});'></c:out>">
										<div class="container container-slide">
											<div class="image_wrapper">
												<img src="photos/newBorn/max/<c:out value='${imagesArr[i]}'></c:out>" alt="newBorn photography" />
		...
		<div class="mobile" id="mobileView">
			<ul>
				<c:forEach var="i" begin="0" end="${maxTagCount-1}">
					<li><img data-src="photos/newBorn/med/<c:out value='${imagesArr[i]}'></c:out>" /></li>
				</c:forEach>
			</ul>
		</div>
	</section>
