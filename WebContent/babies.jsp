...
<meta name="description"
	content="Exclusive collection of awesome babies, toddler photographs by Manogna Reddy. Experience the best photoshoot of your babies with Manogna Reddy. Baby photographer, Hyderabad." />
<title>Baby | Babies | Kids Photography by Manogna Reddy, Hyderabad</title>
<meta charset="UTF-8">
...
<body>
			...
			<nav class="navbar navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
						...
						<li class="nav-item"><a class="nav-link link text-blue display-4" id="babiesMenu" href="babies"> &nbsp;Babies</a></li>
	...
	<section class="carousel slide cid-qtvcqPaJB9" data-interval="false" id="slider2-14" data-rv-view="2268">
							...
							<div class="carousel-inner" role="listbox">
								...
								<c:forEach var="i" begin="0" end="${maxTagCount-1}">
									<div class="carousel-item slider-fullscreen-image <c:if test="${i == 0}"> active</c:if>" id="sd1" data-bg-video-slide="false"
										style="background-image: url(photos/babies/max/<c:out value='${imagesArr[i]});'></c:out>">
										<div class="container container-slide">
											<div class="image_wrapper">
												<img src="photos/babies/max/<c:out value='${imagesArr[i]}'></c:out>" alt="baby photography" />
		...
		<div class="mobile" id="mobileView">
			<ul>
				<c:forEach var="i" begin="0" end="${maxTagCount-1}">
					<li><img data-src="photos/babies/med/<c:out value='${imagesArr[i]}'></c:out>" /></li>
				</c:forEach>
			</ul>
		</div>
	</section>
